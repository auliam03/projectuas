          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <p>
                <center>
                  <h5><strong>Kami memiliki beberapa cabang atau outlet yang siap melayani anda. silahkan berkunjung ke outlet terdekat kami</strong></h5>
                  <div class="table-bordered table-striped text-dark p-1 rounded bg-white">
